...
% Last Modified by GUIDE v2.5 26-Mar-2021 07:51:18
...
% --- Executes on button press in densenet.
function densenet_Callback(hObject, eventdata, handles)
% hObject    handle to densenet (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

load densenetgr.mat;
PreprocessesImages=handles.a;
...
YPred3=char(YPred3);
set(handles.edit1,'String',YPred3);
